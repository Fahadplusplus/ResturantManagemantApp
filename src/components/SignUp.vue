    ...
    <div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <form>
            <div class="mb-1">
                ...
                <input v-model="userDetails.name" id="name" type="text"
            ...
            <div class="mb-1">
                ...
                <input v-model="userDetails.email" id="email" type="email"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none"
            ...
            <div class="mb-1">
                ...
                <input v-model="userDetails.password" id="password" type="password"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none"
            ...
            <button @click.prevent="HandelSubmit" type="submit"
...
function HandelSubmit() {
  ...
  isConfirmPass.value = false
    ...
    if(!isName.value && !isEmail.value && !isPass && !isConfirmPass) {
        userDetails.name = ""
        userDetails.email= ""
